...
namespace {
	...
	struct fastq_reader_delegate final : public lb::fastq_reader_delegate
	{
		fastq_input input;
	...
	{
	private:
		void report_unexpected_character(char const *line_start, std::size_t const lineno, int const current_state) const override
		{
			throw std::runtime_error{"Unexpected character"};
		}

		void report_unexpected_eof(char const *line_start, std::size_t const lineno, int const current_state) const override
		{
			throw std::runtime_error{"Unexpected EOF"};
		}

		void report_length_mismatch(char const *line_start, std::size_t const lineno, int const current_state) const override
		{
