...
namespace libbio {
	...
	public:
		...
		inline ~gengetopt_parser_wrapper();
		gengetopt_parser_wrapper(gengetopt_parser_wrapper const &) = delete;
		gengetopt_parser_wrapper(gengetopt_parser_wrapper &&) = default;		
		gengetopt_parser_wrapper &operator=(gengetopt_parser_wrapper const &) & = delete;
		gengetopt_parser_wrapper &operator=(gengetopt_parser_wrapper &&) & = default;
	...
	gengetopt_parser_wrapper::~gengetopt_parser_wrapper()
	{
		cmdline_parser_free(&m_args);
	}
